...
flake8-html could always use more documentation, whether as part of the
official flake8-html docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
$ py.test tests.test_flake8_html
